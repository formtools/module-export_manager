...
class General
{
     ...
     */
    public function getExportIcons()
    {
...
//  $_SESSION["ft"]["export_manager"]["cache_multi_select_fields"] = $settings["cache_multi_select_fields"];
    ...
    function exp_display_export_options($template_name, $params)
    {
        ...
        foreach ($export_groups as $export_group) {
            ...
            $page_vars["export_group_{$export_group_id}_results"] = ft_load_module_field("export_manager",
            "export_group_{$export_group_id}_results", "export_group_{$export_group_id}_results");
            $page_vars["export_group_{$export_group_id}_export_type"] = ft_load_module_field("export_manager",
    ...
    function exp_insert_default_data()
    {
        ...
        foreach ($queries as $query) {
            ...
            if (!$result) {
                return array(
                false,
                $LANG["export_manager"]["notify_installation_problem_c"] . " <b>" . mysql_error() . "</b>"
                );
            }
        }
